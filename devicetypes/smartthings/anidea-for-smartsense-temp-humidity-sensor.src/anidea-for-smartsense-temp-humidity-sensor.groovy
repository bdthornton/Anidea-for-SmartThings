...
metadata {
	...
	definition(name: "Anidea for SmartSense Temp/Humidity Sensor", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.thermostat", mnmn: "SmartThings", vid: "generic-humidity") {
		...
		fingerprint manufacturer: "eWeLink", model: "TH01", deviceJoinName: "eWeLink Temperature and Humidity Sensor" // Sonoff SNZB-02
	}
...
//	} else if (isFrientSensor()) {
	} else if (isFrientSensor() || isSonoffSensor()) {
...
private Boolean isSonoffSensor() {
